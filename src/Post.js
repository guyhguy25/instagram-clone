            ...
            <div className="app__post">
                <div className="post">
                    <div className="post__header">
                        <a className="usernamea" href="/Christopher">
                            <Avatar className="post__avatar" alt="Christopher" src={userimage}/>
                        </a>
                        <h3><a className="usernamea" href="/Christopher" style={{fontSize: "16px"}}><strong>Christopher</strong></a></h3>
                    ...
                    <Slider {...settings}>
                        <img alt="UserImage" className="post__image" src={userupload}></img>
                        <img alt="UserImage" className="post__image" src={userupload2}></img>
                    </Slider>
                    <div className="post__UI">
                        ...
                        <Button onClick={() => {document.getElementById("postId").focus()} }>
                    ...
                    <span className="post__text">be the first like</span>
                    <div className="post__comments">
                        <span className="caption_title">
                            <strong><a title="Christopher" href="/Christopher">Christopher</a></strong> Hey Guys, This is a test title.
                        </span>
                        <p>
                            <strong><a className="usernamea" href="/Nicholas">Nicholas</a></strong> Hey, This is a test comment.
                        </p>
                    ...
                    <form className="post__commentBox">
                        <input id="postId" className="post__input" type="text" placeholder="Add a comment..."/>
